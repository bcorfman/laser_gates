...
class TestGetResourcePath:
    ...
    def test_normal_development_environment(self):
        ...
        assert result.endswith("res/dart.png")
    ...
    def test_normal_development_with_nonexistent_file(self):
        ...
        assert result.endswith("res/fake_file.png")
    ...
    def test_frozen_without_meipass_nuitka_standalone(self):
        ...
        with patch("sys.frozen", True, create=True), \
            ...
            assert result.endswith("res/dart.png")
            assert "/some/path/res/dart.png" in result or "/some" in result
    ...
    def test_frozen_with_meipass_pyinstaller(self):
        ...
        with patch("sys.frozen", True, create=True), \
            ...
            assert "/tmp/pyinstaller_extracted/res/dart.png" in result
    ...
    def test_frozen_without_meipass_exe_path_resolution(self):
        ...
        with patch("sys.frozen", True, create=True), \
            ...
            assert "/home/user/myapp/res/dart.png" in result
    ...
    def test_handles_relative_path_correctly(self):
        ...
        for rel_path in test_paths:
            ...
            assert rel_path.replace("../", "") in result or result.endswith(rel_path)
...
class TestConfigConstants:
    ...
    def test_hill_slices_all_defined(self):
        ...
        assert all("/hill_slice" in slice_path or "\\hill_slice" in slice_path 
                   for slice_path in config.HILL_SLICES)
